...
COMMON_ARGS="--domain_name robosuite_stack \
  ...
  --num_train_steps 100000 --save_tb --save_video --replay_buffer_load_dir ./demo/robosuite_stack/10 \
...
echo "=== 제안 방법론(decouple) 실험 시작 (stack) ==="
python train.py $COMMON_ARGS --work_dir ./data/robosuite_stack/lane_dino_decouple --reward_camera decouple

echo "실험이 완료되었습니다. tensorboard --logdir ./data/robosuite_stack/lane_dino_decouple 로 결과를 확인하세요."
